...
const Footer = () => {
  return (
    ...
    <footer className="z-50   border-t border-cyan-500/20 bg-slate-900 px-4 py-2 text-center text-sm font-bold text-cyan-300 sm:px-8 sm:text-base select-none">
      {/* <div>
        Created with ReactJS & TailwindCSS|&nbsp; Made by Preet&nbsp; |&nbsp;&copy; 2026 All Rights Reserved
      </div>   */}
      <div className="text-sm text-gray-400">
    Built with <span className="text-cyan-400">ReactJS</span> &{" "}
    <span className="text-cyan-400">TailwindCSS</span>
    {" | "} Made by <span className="text-cyan-400">Preet</span>
